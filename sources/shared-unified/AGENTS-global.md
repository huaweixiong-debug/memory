...
## 九、共享 Memory 更新规则（2026-09-02 起强制）
...
- 写入位置（按来源追加，保留来源标记和日期）：Codex 当前账号 → `sources/current-codex/`；OpenCode → `sources/opencode/`；跨账号通用结论 → `sources/shared-unified/UNIFIED_MEMORY.md`
